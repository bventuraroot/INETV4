        ...
        <tr valign="top">
            <td width=45%>
                <table width="100%">
                    ...
                    <tr>
                        <td>Actividad económica:{{$emisor["descActividad"]}}</td>
                    </tr>
                    <tr>
                        <td>Dirección: {{$emisor["direccion"]["complemento"]}}<br>
                        {{$emisor["direccion"]["dsmunicipio"]}},{{$emisor["direccion"]["dsDepartamento"]}}</td>
                    </tr>
                    <tr>
                        <td>Número de teléfono:{{$emisor["telefono"]}}</td>
                    </tr>
                    <tr>
                        <td>Correo electrónico:{{$emisor["correo"]}}</td>
                    </tr>
                    <tr>
                        <td>Nombre comercial:{{$emisor["nombreComercial"]}}</td>
                    </tr>
                    <tr>
