...
$(function () {
  ...
  var dt_user_table = $('.datatables-client'),
  ...
  if (dt_user_table.length) {
    var dt_user = dt_user_table.DataTable({
      ...
      buttons: [
        ...
        {
          text: '<i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">Nuevo Cliente</span>',
      ...
      initComplete: function () {
        ...
        this.api()
          ...
          .every(function () {
            var column = this;
            var select = $(
              '<select id="selectcompany" class="select2company form-select"><option value="selectcompany"> Seleccionar empresa </option></select>'
            )
              .appendTo('.companies')
              .on('change', function () {
